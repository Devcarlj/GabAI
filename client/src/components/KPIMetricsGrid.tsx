  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <div className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex flex-col justify-between">
        ...
        {isLoading ? (
          <div className="skeleton-bone h-8 w-16 rounded mt-2" />
        ) : (
      ...
      <div className="bg-slate-900 border border-red-950 p-4 rounded-xl flex flex-col justify-between">
        <span className="text-xs text-red-400 font-medium tracking-wider uppercase">
          Critical Urgency
        </span>
        {isLoading ? (
          <div className="skeleton-bone h-8 w-16 rounded mt-2" />
      ...
      <div className="bg-slate-900 border border-amber-950 p-4 rounded-xl flex flex-col justify-between">
        ...
        {isLoading ? (
          ...
          <span className="text-3xl font-bold text-amber-500 mt-2">
            {highCount}
          </span>
        )}
      </div>
