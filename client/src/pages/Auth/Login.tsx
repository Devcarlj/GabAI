    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(circle, rgba(255,60,49,0.06) 0%, transparent 70%)",
          borderRadius: "50%",
        }}
      />
      ...
      >
          ...
          >
            <img
              ...
              style={{
                ...
                height: "24px",
                filter:
                  "brightness(0) saturate(100%) invert(23%) sepia(96%) saturate(3628%) hue-rotate(346deg) brightness(99%) contrast(91%)",
              }}
            />
          </div>
          <h1
        ...
        {error && (
          ...
          >
            ...
            />
            <span
              style={{ fontSize: "13px", color: "#F87171", lineHeight: 1.4 }}
            >
              {error}
            </span>
          </div>
        ...
        <Link
          ...
          style={{
            marginTop: "16px",
            padding: "12px 16px",
            border: "1px solid rgba(255,60,49,0.35)",
            borderRadius: "10px",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
